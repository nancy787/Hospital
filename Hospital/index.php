...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container" >
                <a href="#" class="navbar-brand text-warning"><i class="far fa-hand-spock"></i>HOSPITAL</a>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="slogin.php" class="nav-link "><i class="fas fa-bars"></i>Staff </a>
                    </li>
                    <li class="nav-item">
                        <a href="Alogin.php" class="nav-link "><i class="fas fa-user-shield"></i>ADMIN</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link "><i class="fas fa-comment"></i>PATIENT</a>
                    </li>
         ...
         <div class="container">
             <div class="row">
                 <div class="col-md-12">
                     <h1><i class="fas fa-text-height"style="color: turquoise;;"></i>basic</h1>
                 </div>
             </div>
