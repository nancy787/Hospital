...
function Login_Attempt($UserName,$Password){
    global $ConnectingDB;
    $sql = "SELECT * FROM doctor WHERE user=:drname AND password=:drpass LIMIT 1";
    $stmt = $ConnectingDB->prepare($sql);
    $stmt->bindValue(':drname',$UserName);
    $stmt->bindValue(':drpass',$Password);
    $stmt->execute();
        ...
        <div class="row">
            ...
            <div class="card bg-secondary y text-light">
                <div class="card-header">
                    ...
                    <form class=" " action="img.php" method="post">
